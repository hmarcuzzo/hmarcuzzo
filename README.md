...
### 👨🏻‍💻 **About Me**
Python Backend Engineer with 4+ years building backend systems across consulting, AI, and enterprise environments. Currently an Advanced Software Engineer at Zühlke Group, maintaining a national-scale microservices ecosystem for the Co-operative Group (UK).

Building toward Tech Lead and Software Architect roles, with growing depth in infrastructure-as-code and cloud-native delivery.


### 🚀 Open Source

- **[FastGear](https://github.com/hmarcuzzo/fastgear)** — Reusable component library for FastAPI applications
- **[FastGear CLI](https://github.com/hmarcuzzo/fastgear-cli)** — CLI tool that generates FastAPI projects with standardized structure and configuration
...
### ⚡ Skills
  ...
  - #### 🔄 CI/CD
  &emsp;&emsp;![GitHub Actions](https://img.shields.io/badge/github%20actions-%232671E5.svg?style=for-the-badge&logo=githubactions&logoColor=white)
